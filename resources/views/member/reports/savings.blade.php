...
@section('title', 'Laporan Simpanan Saya')

@section('content')
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h1 class="h2">Laporan Simpanan Saya</h1>
</div>

<div class="card mb-3">
    <div class="card-body">
        <form method="GET" action="{{ route('member.reports.savings') }}" class="row g-3">
            <div class="col-md-3">
...
<div class="row mb-3">
    ...
    <div class="col-md-4">
        <div class="card text-white bg-primary">
            <div class="card-body">
                <h6 class="text-uppercase">Saldo Akhir</h6>
                <h3 class="mb-0">Rp {{ number_format(Auth::user()->member->getCurrentBalance(), 0, ',', '.') }}</h3>
            </div>
        </div>
    </div>
</div>
